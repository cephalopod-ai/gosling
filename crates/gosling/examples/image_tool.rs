...
async fn main() -> Result<()> {
    ...
    // Create providers
    let providers: Vec<(
        Arc<dyn gosling::providers::base::Provider>,
        ...
        (
            ...
            gosling::model_config::model_config_from_user_config("openai", OPEN_AI_DEFAULT_MODEL)?,
        ),
        (
    ...
    for (provider, model_config) in providers {
        ...
        let image_data = fs::read("crates/gosling/examples/test_assets/test_image.png")?;
