...
use gosling::agents::{Agent, AgentEvent, GoslingPlatform};
use gosling::config::extensions::{set_extension, ExtensionEntry};
...
mod tests {
    ...
    mod max_turns_tests {
        ...
        impl gosling::providers::base::ProviderDescriptor for MockToolProvider {
    ...
    mod unparseable_tool_call_tests {
        ...
        impl gosling::providers::base::ProviderDescriptor for UnparseableToolProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod tool_pair_summarization_tests {
        ...
        use async_trait::async_trait;
        use gosling::agents::SessionConfig;
        use gosling::config::base::Config;
        use gosling::config::GoslingMode;
        ...
        impl gosling::providers::base::ProviderDescriptor for SummarizationTestProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        async fn test_batch_summarization_preserves_all_summaries() -> Result<()> {
            ...
            Config::global()
                .set_param("GOSLING_TOOL_CALL_CUTOFF", 2)
                .unwrap();
            ...
            Config::global().delete("GOSLING_TOOL_CALL_CUTOFF").unwrap();
        ...
        async fn setup_agent_with_extension_manager() -> (Agent, String) {
            ...
            let todo_extension_entry = ExtensionEntry {
                ...
                config: ExtensionConfig::Platform {
                    name: "todo".to_string(),
                    description:
                        "Enable a todo list for gosling so it can keep track of what it is doing"
                            .to_string(),
    ...
    mod streaming_persistence_tests {
        ...
        impl gosling::providers::base::ProviderDescriptor for MultiStepProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod thinking_preservation_tests {
        ...
        impl gosling::providers::base::ProviderDescriptor for ThinkingStreamProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        impl gosling::providers::base::ProviderDescriptor for CombinedThinkingToolProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        impl gosling::providers::base::ProviderDescriptor for MultiToolThinkingProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod goal_checking_tests {
        ...
        impl gosling::providers::base::ProviderDescriptor for GoalTextProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod frontend_extension_tests {
        use super::*;
        use gosling::agents::{AgentConfig, ExtensionConfig};
        use gosling::config::permission::PermissionManager;
        use gosling::config::GoslingMode;
        use gosling::session::session_manager::SessionType;
        use gosling::session::{
