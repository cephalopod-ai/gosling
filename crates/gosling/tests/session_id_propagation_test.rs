...
use gosling::providers::api_client::{ApiClient, AuthMethod};
use gosling::providers::base::Provider;
use gosling::providers::openai::OpenAiProvider;
use gosling::session_context::{session_id_request_builder, SESSION_ID_HEADER};
...
async fn make_request(provider: &dyn Provider, session_id: &str) {
    ...
    let _ = gosling::session_context::with_session_id(
