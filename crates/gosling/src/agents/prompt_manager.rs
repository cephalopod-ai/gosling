...
impl<'a> SystemPromptBuilder<'a, PromptManager> {
    ...
    pub fn with_gosling_mode(mut self, mode: GoslingMode) -> Self {
    ...
    pub fn build(self) -> String {
        ...
        let context = SystemPromptContext {
            ...
            gosling_mode,
            is_autonomous: gosling_mode == GoslingMode::Auto,
        ...
        .unwrap_or_else(|_| {
            "You are a general-purpose AI agent called gosling, a lighter fork of goose \
             (originally created by AAIF, the Agentic AI Foundation; gosling itself is an \
             independent, unaffiliated fork)."
                .to_string()
        });
...
mod tests {
    ...
    async fn test_all_platform_extensions() {
        ...
        let _guard = env_lock::lock_env([
            ...
            ("GOSLING_PATH_ROOT", Some(temp_root.as_str())),
        ]);
