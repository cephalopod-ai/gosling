...
// These are used by integration tests in crates/gosling/tests/
    ...
    || {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Gosling will make extension calls through code execution, saving tokens",
                default_enabled: false,
                unprefixed_tools: true,
                hidden: false,
                client_factory: |ctx| {
...
impl PlatformExtensionContext {
    pub async fn model_config_for_session(
        &self,
        session_id: &str,
    ) -> Result<gosling_providers::model::ModelConfig, String> {
