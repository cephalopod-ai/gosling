...
<html>
  <head>
    <title>gosling - Google Authorization Successful</title>
    <style>
      body {
...
<html>
  <head>
    <title>gosling - Google Authorization Failed</title>
    <style>
      body {{
        font-family: system-ui, -apple-system, sans-serif;
        display: flex;
...
impl gosling_providers::base::ProviderDescriptor for GeminiOAuthProvider {
