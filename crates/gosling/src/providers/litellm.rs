...
impl gosling_providers::base::ProviderDescriptor for LiteLLMProvider {
...
impl Provider for LiteLLMProvider {
    ...
    async fn stream(
        ...
        let mut payload = gosling_providers::formats::openai::create_request(
            model_config,
            system,
            messages,
            tools,
        ...
        let message = gosling_providers::formats::openai::response_to_message(&response)?;
        let usage = gosling_providers::formats::openai::get_usage(&response);
