...
impl gosling_providers::base::ProviderDescriptor for GeminiCliProvider {
    fn metadata() -> ProviderMetadata {
        ProviderMetadata::new(
            GEMINI_CLI_PROVIDER_NAME,
            "Gemini CLI",
            "[Deprecated: use Google Gemini (API Key) instead] Execute Gemini models via gemini CLI tool. Requires gemini CLI installed.",
...
impl Provider for GeminiCliProvider {
    ...
    async fn stream(
        ...
        super::cli_common::reject_hosted_tools("Gemini CLI", tools)?;
