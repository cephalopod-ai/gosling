use gosling::acp::custom_notifications::custom_notification_schemas;
use gosling::acp::server::{agent_request_schemas, GoslingAcpAgent};
...
fn main() {
    ...
    let methods = GoslingAcpAgent::custom_method_schemas(&mut generator);
...
fn is_unstable_method(method: &str) -> bool {
    method.contains("_gosling/unstable")
}
