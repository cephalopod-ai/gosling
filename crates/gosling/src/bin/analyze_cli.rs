...
//! Usage: cargo run -p gosling --bin analyze_cli -- <path> [--focus <symbol>] [--depth <n>] [--follow <n>] [--force]

use clap::Parser;
use gosling::agents::platform_extensions::analyze::{format, graph, AnalyzeClient};
use rayon::prelude::*;
