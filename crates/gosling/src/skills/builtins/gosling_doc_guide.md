---
name: gosling-doc-guide
description: Reference gosling documentation to create, configure, or explain gosling-specific features like extensions, sessions, and providers. You MUST fetch relevant gosling docs before answering. You MUST NOT rely on training data or assumptions for any gosling-specific fields, values, names, syntax, or commands.
---

Use this skill when working with **gosling-specific features**:
- Configuring extensions or providers
- Explaining how gosling features work
- Any gosling configuration or setup task

Do NOT use this skill for:
- General coding tasks unrelated to gosling

## Steps (COMPLETE ALL BEFORE RESPONDING)
1. **Fetch official docs**
   - Fetch the doc map from `https://gosling-docs.ai/gosling-docs-map.md`
   ...
   - Fetch: `https://gosling-docs.ai/docs/guides/sessions/session-management.md`
...
2. **Create/modify content**
   - For gosling configuration files:
      ...
      - **⚠️ STOP: Before showing the user, verify output content MUST match the schema and reference in the gosling official documentation:**
...
3. **MANDATORY VERIFICATION - CHECK ALL THESE ITEMS BEFORE STEP 4**
   ...
   - [ ] You MUST NOT rely on training data or assumptions for any gosling-specific fields, values, names, syntax, or commands.
   ...
   - [ ] List all gosling-specific items in your answer (commands, fields, syntax, values, how to use, explanations, etc.)
...
4. **Provide your answer and include a "Verification Completed" section**
   - For EACH gosling-specific item in your response, cite the specific doc file where you verified it

5. **List documentation links**
   - Only include docs actually used
   - Remove `.md` suffix from URLs
   - Example: If you fetched `https://gosling-docs.ai/docs/guides/sessions/session-management.md`, list it as `https://gosling-docs.ai/docs/guides/sessions/session-management`
