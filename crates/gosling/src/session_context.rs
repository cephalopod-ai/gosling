...
pub fn session_id_request_builder() -> gosling_providers::api_client::RequestBuilderDecorator {
...
/// Local OS user running gosling, shared by the OTLP `user.name` resource
...
/// Hostname of the machine running gosling, shared by the OTLP `host.name`
