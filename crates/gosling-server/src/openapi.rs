...
use gosling::agents::extension::ToolInfo;
use gosling::agents::ExtensionConfig;
use gosling::config::permission::PermissionLevel;
use gosling::config::ExtensionEntry;
use gosling::conversation::token_usage::Usage;
use gosling::conversation::Conversation;
use gosling::providers::base::{ConfigKey, ModelInfo, ProviderMetadata, ProviderType};
use gosling::session::{
    DiagnosticsConfig, DiagnosticsError, DiagnosticsExtensions, DiagnosticsLevel, DiagnosticsLogs,
    DiagnosticsPrompt, DiagnosticsReport, DiagnosticsTextFile, Session, SessionType, SystemInfo,
};
use gosling_providers::model::ModelConfig;
use gosling_providers::permission::Permission;
use gosling_providers::permission::PrincipalType;
...
#[openapi(
    ...
    components(schemas(
        ...
        gosling::providers::catalog::ProviderCatalogEntry,
        gosling::providers::catalog::ProviderTemplate,
        gosling::providers::catalog::ModelTemplate,
        gosling::providers::catalog::ModelCapabilities,
        ...
        gosling::prompt_template::Template,
        ...
        Session,
        gosling_providers::gosling_mode::GoslingMode,
        SessionType,
        SystemInfo,
        DiagnosticsConfig,
        DiagnosticsError,
        ...
        IconSchema,
        IconThemeSchema,
        gosling::session::extension_data::ExtensionData,
        ...
        gosling::agents::ExtensionLoadResult,
        ...
        gosling::dictation::providers::DictationProvider,
