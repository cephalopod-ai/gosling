...
#[notification(method = "_gosling/unstable/session/update")]
...
impl Default for GoslingSessionUpdate {
    fn default() -> Self {
        GoslingSessionUpdate::UsageUpdate(SessionUsageUpdate::default())
    }
}
...
/// Schemas for every gosling-custom outbound notification. To register a new
...
mod tests {
    ...
    fn status_message_serializes_to_expected_wire_shape() {
        let notification = GoslingSessionNotification {
            ...
            update: GoslingSessionUpdate::StatusMessage(StatusMessageUpdate {
