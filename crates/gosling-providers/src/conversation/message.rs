...
pub const TOOL_META_EXTERNAL_DISPATCH_KEY: &str = "gosling.external_dispatch";
...
pub const TOOL_META_TITLE_KEY: &str = "gosling.toolSummary.title";
...
pub const TOOL_META_CHAIN_SUMMARY_KEY: &str = "gosling.toolChain.summary";
...
pub struct MessageMetadata {
    ...
    /// surfaced as `_meta.gosling.steer` so clients can mark the steer boundary
...
mod tests {
    ...
    fn test_elicitation_response_defaults_action_to_accept() {
        ...
        assert_eq!(user_data, serde_json::json!({ "name": "gosling" }));
