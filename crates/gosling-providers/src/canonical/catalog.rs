...
const SETUP_METADATA: &[CuratedSetupMetadata] = &[
    ...
    CuratedSetupMetadata {
        ...
        display_name: Some("Featherless AI"),
        description: Some("Open source models via Featherless's OpenAI-compatible API"),
        docs_url: Some("https://featherless.ai/docs/quickstart-guide"),
...
fn synthetic_gosling_setup_entry(curated: &CuratedSetupMetadata) -> ProviderSetupCatalogEntry {
    ProviderSetupCatalogEntry {
        provider_id: curated.provider_id.to_string(),
        display_name: curated.display_name.unwrap_or("Gosling").to_string(),
        category: ProviderSetupCategory::Agent,
    ...
    SETUP_METADATA
        ...
        .filter_map(|curated| {
            if curated.synthetic {
                return Some(synthetic_gosling_setup_entry(curated));
            }
