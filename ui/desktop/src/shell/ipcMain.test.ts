...
function harness() {
  ...
  const operations = {
    ...
    extensionsAvailableRead: vi.fn(() => ({ extensions: [] })),
    sessionExtensionsRead: vi.fn(() => ({ extensions: [] })),
    sessionExtensionsAdd: vi.fn(() => ({ extensions: [] })),
    sessionExtensionsRemove: vi.fn(() => ({ extensions: [] })),
