...
1. **Session Outputs:** write the canonical report, tutorial, appendix, or exported data summary in the active workspace output location. Reference its exact path in the final response so Gosling records it in this session's Outputs inventory.
