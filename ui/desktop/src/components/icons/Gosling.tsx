export function Gosling({ className = '' }) {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path
        d="M 95 59 L 84 84 L 87 133 L 105 175 L 133 213 L 66 182 L 59 195 L 61 214 L 88 266 L 142 311 L 78 302 L 75 320 L 106 364 L 175 401 L 120 407 L 138 438 L 190 481 L 246 509 L 188 571 L 130 650 L 71 708 L 75 720 L 106 723 L 78 750 L 70 774 L 90 777 L 121 765 L 108 802 L 128 807 L 174 787 L 245 735 L 356 701 L 434 654 L 476 611 L 509 558 L 528 502 L 540 420 L 559 383 L 635 346 L 686 340 L 694 331 L 646 302 L 626 270 L 603 255 L 575 249 L 539 255 L 499 289 L 476 366 L 458 400 L 436 421 L 413 425 L 400 407 L 379 327 L 356 293 L 204 163 L 106 62 Z"
        fill="currentColor"
      />
    </svg>
  );
