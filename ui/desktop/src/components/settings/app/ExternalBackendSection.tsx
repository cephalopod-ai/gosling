...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default Gosling starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. Gosling checks /status and connects to /acp under this base.',
  },
  secretKey: {
  ...
  restartNote: {
    ...
    defaultMessage:
      'Changes apply to new chat windows. Restart Gosling to update existing windows.',
  },
  urlProtocolError: {
