...
const i18n = defineMessages({
  ...
  focusWindowLabel: {
    ...
    defaultMessage: 'Focus Gosling Window',
  },
  focusWindowDescription: {
    id: 'keyboardShortcuts.focusWindowDescription',
    defaultMessage: 'Bring Gosling window to front from anywhere',
  },
  quickLauncherLabel: {
  ...
  newChatWindowDescription: {
    ...
    defaultMessage: 'Open a new Gosling window',
  },
  openDirectoryLabel: {
  ...
  categoryGlobalDescription: {
    ...
    defaultMessage: 'These shortcuts work system-wide, even when Gosling is not focused',
  },
  categoryApplication: {
  ...
  categoryApplicationDescription: {
    ...
    defaultMessage: 'These shortcuts work when Gosling is the active application',
  },
  categorySearch: {
  ...
  restartDescription: {
    ...
    defaultMessage:
      'Changes to application shortcuts (like New Chat, Settings, etc.) require restarting Gosling to take effect. Global shortcuts (Focus Window, Quick Launcher) work immediately.',
  },
  dismiss: {
