...
const i18n = defineMessages({
  ...
  noSkillsDescription: {
    ...
    defaultMessage:
      'Skills are loaded from SKILL.md files in ~/.config/agents/skills/, .gosling/skills/, or other supported directories.',
  },
  noMatchingSkills: {
  ...
  skillsDescription: {
    ...
    defaultMessage: 'View installed skills that extend Gosling capabilities. {shortcut} to search.',
  },
