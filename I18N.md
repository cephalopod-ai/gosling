# Internationalization (i18n) — Gosling Desktop UI

This document describes the i18n infrastructure for the Gosling Desktop UI (`ui/desktop/`).
...
2. **`GOSLING_LOCALE`** — explicit override from env/app config when the desktop setting is
   System Default
