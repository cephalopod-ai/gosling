...
in the repository-level licensing and attribution documents; a future header
policy requires an explicit, repository-wide decision before any bulk change.
