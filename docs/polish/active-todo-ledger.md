...
| MOD-GSL-001 | open | P2 | Modularization | `docs/TODO.md` | 2026-07-18 | 2026-09-01 | Modularize the final routed file, `crates/gosling/src/agents/agent.rs`, in a dedicated change. |
