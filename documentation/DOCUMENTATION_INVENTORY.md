...
| `documentation/INDEX.md` | Documentation index | current | Documentation governance | Updated 2026-09-13 | Links the dated comparison, v1.2.5 candidate notes, 127-card playtest, and consolidated audit repair. |
