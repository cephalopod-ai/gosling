...
The Fetch extension [does not work](https://github.com/cephalopod-ai/gosling/issues/1184) with Google models (e.g. gemini-2.0-flash) because this extension uses `format: uri` in its JSON schema which Google doesn't support.
:::
