...
<Tabs groupId="interface">
  ...
  [Launch the installer](gosling://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fcephalopod-ai.gitmcp.io%2Fgosling%2F&id=gosling-docs&name=gosling%20Docs&description=gitmcp%20for%20gosling%20documentation)
  </TabItem>
  <TabItem value="cli" label="gosling CLI">
  **Command**
  ```sh
  npx mcp-remote https://cephalopod-ai.gitmcp.io/gosling/
  ```
  </TabItem>
</Tabs>
:::
...
<Tabs groupId="interface">
  <TabItem value="ui" label="gosling Desktop" default>
    <GoslingDesktopInstaller
      ...
      command="npx"
      args={["mcp-remote", "https://cephalopod-ai.gitmcp.io/gosling/"]}
      cliCommand="npx mcp-remote https://cephalopod-ai.gitmcp.io/gosling/"
      timeout={300}
  ...
  <TabItem value="cli" label="gosling CLI">
      <CLIExtensionInstructions
        name="gosling Docs"
        description="GitMCP for gosling documentation"
        command="npx mcp-remote https://cephalopod-ai.gitmcp.io/gosling/"
        timeout={300}
      />
  </TabItem>
</Tabs>
...
4. Add our team MCP servers as extensions:
   ...
   - gosling Docs: `npx mcp-remote https://cephalopod-ai.gitmcp.io/gosling/`
