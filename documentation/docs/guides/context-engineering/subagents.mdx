...
Internal subagents spawn goose instances to handle tasks using your current session's context and extensions. You configure and execute internal subagents with direct prompts.
...
<ContentCardCarousel
  items={[
    ...
    },
    {
      ...
      description: 'Discover how to choose the right tools for efficient task execution in goose. Learn which approach is best for your workflow.',
