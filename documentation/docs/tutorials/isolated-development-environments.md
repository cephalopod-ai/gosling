...
This guide shows you how to set up isolated development environments using the **[Container Use MCP](https://github.com/dagger/container-use)** with gosling. With this setup, your development work will be isolated to both git branches and containers, allowing you to experiment freely without affecting your main system state.
...
The **[Container Use MCP](https://github.com/dagger/container-use)** server provides containerized development environments that integrate seamlessly with gosling. This allows you to:
...
If you develop inside Docker containers (like VS Code Remote-Containers), see how you can [run extensions in your existing containers](/docs/tutorials/gosling-in-docker#running-extensions-in-docker-containers).
:::
...
- gosling installed and configured
...
Once the extension is enabled in gosling, you can:

### Starting Isolated Development

Simply mention in your conversation with gosling that you want to work in an isolated environment:
...
1. Start a conversation with gosling about a new feature
2. Request isolated development environment
3. gosling creates branch and container
4. Develop and test the feature
5. If successful, merge the branch; if not, discard it

### Dependency Exploration

1. Ask gosling to explore a new library or tool
...
3. Ask for support in [GitHub Discussions](https://github.com/cephalopod-ai/gosling/discussions)

## Next Steps

With container-use enabled in gosling, you're ready to develop with confidence. Try starting a conversation about a project you've been hesitant to experiment with, and let gosling set up a safe, isolated environment for your exploration.
