---
description: Integrate gosling with Laminar to observe performance
---

# Observability with Laminar

This tutorial covers how to integrate gosling with Laminar to trace your gosling sessions and understand how the agent is performing.
...
## Configure gosling to export OTLP to Laminar

gosling exports OpenTelemetry data over OTLP/HTTP. Point the exporter to Laminar and provide your API key as an authorization header.
...
## Run gosling with Laminar enabled

Start gosling normally. With the OTLP environment variables set, Laminar will capture traces of your gosling sessions and tool execution.

_[Example trace (public) in Laminar](https://laminar.sh/shared/traces/63010af0-cf31-b8b6-0d77-fc9924bcaa4c)_

![gosling trace in Laminar](../assets/guides/laminar.png)
