...
interface GoslingDesktopInstallerProps {
  extensionId: string;
...
export default function GoslingDesktopInstaller({
  extensionId,
  extensionName,
  description,
  type,
  ...
  const buildGoslingUrl = () => {
    ...
    return `gosling://extension?${urlParts.join('&')}`;
  };
  ...
  return (
    <div>
      <ol>
        <li>
          <a href={buildGoslingUrl()}>Launch the installer</a>
        </li>
