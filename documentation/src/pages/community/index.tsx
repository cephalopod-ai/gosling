  ...
  return (
    <section className="w-full flex flex-col items-center gap-8 my-8">
      ...
      <p className="italic text-textStandard">
        Have ideas for future events? Start a thread in <Link href="https://github.com/cephalopod-ai/gosling/discussions">GitHub Discussions</Link>.
      ...
      <div className="card max-w-xl">
        ...
        <div className="card__body text--center">
          ...
          <div className="text-sm">
            ...
            <Link href="https://github.com/cephalopod-ai/gosling">GitHub</Link>, helping others in{' '}
            <Link href="https://github.com/cephalopod-ai/gosling/discussions">GitHub Discussions</Link>, or share your
            gosling projects with the community! You can check out the{' '}
            <Link href="https://github.com/cephalopod-ai/gosling/blob/main/CONTRIBUTING.md">contributing guide</Link>{' '}
            for more tips.
          </div>
        </div>
      </div>
